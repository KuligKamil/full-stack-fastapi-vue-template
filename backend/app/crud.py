...
from app.models import Header, Item, Table
...
async def get_items(
    ...
    table = Table(
        items=[Item(**item) for item in data],
        headers=[
            Header(label="name", field="name", type="string"),
            Header(label="date", field="date", type="date"),
            Header(label="tags", field="tags", type="tags"),
            # Header(label="link", field="link", type="string"),
        ],
        fields=["name", "date", "tags"],
    )
...
async def get_data():
    return [
        {
            "_id": "4f7dfabc-9db7-4bbe-9e03-4f3915f5aecf",
            "name": "Harry Potter",
            "date": "2023-10-01",
        ...
        {
            "_id": "77046bcb-832c-42c2-9d5d-5db3063e1108",
        ...
        {
            "_id": "8107db23-df87-420e-b0b0-91d56efc29c3",
        ...
        {
            "_id": "627c2381-8e39-44ea-9006-8c8cb2de227f",
            "name": "Severus Snape",
            "date": "2023-10-05",
        ...
        {
            "_id": "cd6722a6-ede3-4217-a697-65142f246be1",
            "name": "Draco Malfoy",
            "date": "2023-10-07",
        ...
        {
            "_id": "e7254e63-fc88-4aa6-8d82-26d4822ff321",
        ...
        {
            "_id": "d9364fac-32f3-4537-9ee6-d8ed60cdce99",
            "name": "Sirius Black",
            "date": "2023-10-09",
        ...
        {
            "_id": "672310e5-aa40-45f5-940b-84ecea0e8bbd",
            "name": "Remus Lupin",
            "date": "2023-10-10",
